# RFC-0026: Explicit runtime custody profiles

- Status: Accepted
- Authors: Nomed with implementation support
- Created: 2026-08-05
- Governing issue: #6
- Governing architecture: RFC-0013, RFC-0014, RFC-0018, RFC-0020 and RFC-0025
...
| --- | --- | --- |
| Linux interactive workstation | `linux-secret-service-v1` | Freedesktop Secret Service plus encrypted local SQLite, per RFC-0018 and RFC-0025 |
...
`session bootstrap` retains RFC-0025's closed descriptor and configuration
