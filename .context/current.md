...
- Active increment: RFC-0013 DPoP and credential-store increment not yet started
...
- Next action: implement DPoP request signing and operating-system
  credential-store ports with no plaintext fallback; watch, mutations and a
  process executable remain separate increments
