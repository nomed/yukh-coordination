...
def main():
 ...
 audit_key_statement={"profile":"yukh-security-audit-verification-key/v1","version":1,"key_id":"rfc8032-checkpoint-1","algorithm":"Ed25519","public_key":b64(bytes.fromhex("d75a980182b10ab7d54bfed3c964073a0ee172f3daa62325af021a68f707511a")),"active_from":"2026-08-03T08:00:00.000Z","issued_at":"2026-08-03T08:00:00.000Z"}
 audit_checkpoint={"profile":"yukh-security-audit-checkpoint/v1","ledger_id":audit_ledger_id,"tree_size":7,"root_hash":audit_merkle["tree_heads"][7]["root_hash"],"chain_head":b64(audit_chains[-1]),"issued_at":"2026-08-03T09:00:00.123Z","algorithm":"Ed25519","key_id":"rfc8032-checkpoint-1"}
 audit_checkpoint_signature=bytes.fromhex("9e542c8e30450f0ee09426d7cee33e9b9e500c6f18ea9688d5749cceb4f8effec8c76a327c92c1b7f29ede0c40a6a2d6db03d97e43f876e36ac6c570359a7509")
 audit_checkpoint_reference="audit-checkpoint:"+b64(hashlib.sha256(b"yukh-coordination:audit-checkpoint-reference:v1\n"+jcs(audit_checkpoint)+audit_checkpoint_signature).digest())
 audit_recovery={"profile":"yukh-security-audit-recovery-manifest/v1","manifest_id":"0198f56b-0c00-7000-8000-000000000010","identity_backup":{"backup_id":"0198f56b-0c00-7000-8000-000000000011","database_id":"0198f56b-0c00-7000-8000-000000000012","digest":b64(hashlib.sha256(b"identity-backup").digest()),"captured_at":"2026-08-03T09:00:30.000Z"},"audit_backup":{"backup_id":"0198f56b-0c00-7000-8000-000000000013","database_id":audit_ledger_id,"digest":b64(hashlib.sha256(b"audit-backup").digest()),"captured_at":"2026-08-03T09:00:30.000Z"},"audit_backup_tree_size":7,"audit_backup_root_hash":audit_checkpoint["root_hash"],"checkpoint_reference":audit_checkpoint_reference,"checkpoint_tree_size":7,"checkpoint_root_hash":audit_checkpoint["root_hash"],"consistency_proof":[],"identity_epoch_floors":[{"tenant_id":"tenant-a","principal_id":"A"*43,"epoch":9}],"identity_wall_high_water":"2026-08-03T09:00:00.000Z","created_at":"2026-08-03T09:01:00.000Z","algorithm":"Ed25519","key_id":"rfc8032-checkpoint-1"}
 audit_restore_record={"profile":"yukh-security-audit/v1","operation_id":"0198f56b-0c00-7000-8000-000000000014","operation_kind":"restore_fence","outcome":"allow","reason":"restore_verified","decision_time":"2026-08-03T09:02:00.000Z","checkpoint_reference":audit_checkpoint_reference,"recovery_reference":"audit-recovery:"+b64(hashlib.sha256(b"recovery-reference").digest())}
 audit_revocation_record={"profile":"yukh-security-audit/v1","operation_id":"0198f56b-0c00-7000-8000-000000000015","operation_kind":"revocation","outcome":"allow","reason":"revoked","decision_time":"2026-08-03T09:03:00.000Z","tenant_id":"tenant-a","participant_instance_id":"0198f56b-0c00-7000-8000-000000000002","session_epoch":7,"authority_reference":"authority:revocation:1"}
 audit_jwks_record={"profile":"yukh-security-audit/v1","operation_id":"0198f56b-0c00-7000-8000-000000000016","operation_kind":"jwks_refresh","outcome":"allow","reason":"refreshed","decision_time":"2026-08-03T09:04:00.000Z","authority_reference":"issuer:key-set:1","jwks_set_digest":b64(hashlib.sha256(b"jwks-set").digest())}
 audit_checkpoint_record={"profile":"yukh-security-audit/v1","operation_id":"0198f56b-0c00-7000-8000-000000000017","operation_kind":"audit_checkpoint","outcome":"allow","reason":"checkpoint_committed","decision_time":"2026-08-03T09:05:00.000Z","signing_key_reference":"signing-key:rfc8032-checkpoint-1:1"}
 audit_key_record={"profile":"yukh-security-audit/v1","operation_id":"0198f56b-0c00-7000-8000-000000000018","operation_kind":"audit_key_lifecycle","outcome":"allow","reason":"key_lifecycle_committed","decision_time":"2026-08-03T09:06:00.000Z","authority_reference":"authority:key-statement:1","signing_key_reference":"signing-key:rfc8032-checkpoint-1:1"}
 vector_values={"event":events["claim"],"channel":meta["channel"][0],"evidence-descriptor":evidence(),"evidence-set":[evidence()],"receipt":meta["receipt"][0],"receipt-signature-preimage":receipt_preimage,"diagnostics":[{"sequence":2,"code":"CLAIM_CONFLICT","severity":"warning","primary_id":U[3],"contender_ids":[U[20],U[21]],"contender_event_ids":[U[3],U[4]]}],"audit-record":audit_record,"audit-record-checkpoint":audit_checkpoint_record,"audit-record-jwks-refresh":audit_jwks_record,"audit-record-key-lifecycle":audit_key_record,"audit-record-restore-fence":audit_restore_record,"audit-record-revocation":audit_revocation_record,"audit-receipt":audit_receipt,"audit-merkle":audit_merkle,"audit-verification-key":audit_key_statement,"audit-checkpoint":audit_checkpoint,"audit-recovery-manifest":audit_recovery}
 domains={"channel":"yukh.channel-metadata.v0.1\u0000","evidence-descriptor":"yukh.evidence-descriptor.v0.1\u0000","evidence-set":"yukh.evidence-set.v0.1\u0000","receipt-signature-preimage":"yukh-coordination-receipt-v0.1\u0000","audit-record":"yukh-coordination:audit-record:v1\n","audit-record-checkpoint":"yukh-coordination:audit-record:v1\n","audit-record-jwks-refresh":"yukh-coordination:audit-record:v1\n","audit-record-key-lifecycle":"yukh-coordination:audit-record:v1\n","audit-record-restore-fence":"yukh-coordination:audit-record:v1\n","audit-record-revocation":"yukh-coordination:audit-record:v1\n","audit-verification-key":"yukh-coordination:audit-verification-key:v1\n","audit-checkpoint":"yukh-coordination:audit-checkpoint:v1\n","audit-recovery-manifest":"yukh-coordination:audit-recovery-manifest:v1\n"}
 vectors=[]
 ...
 candidates={*(p for p in OUT.rglob("*") if p.is_file() and p.name!="SHA256SUMS" and "__pycache__" not in p.parts and p.suffix != ".pyc"), *ROOT.joinpath("schema").rglob("*.json"), *ROOT.joinpath("js").rglob("*.mjs"), ROOT/"package.json", ROOT/".gitignore", ROOT/".context/rfcs/RFC-0001-protocol-v0.1.md", ROOT/".context/rfcs/RFC-0002-mvp-security-boundary.md"}
